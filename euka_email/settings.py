...
ALLOWED_HOSTS = ["email.euka.ai", "143.198.61.222", "127.0.0.1"]
...
WSGI_APPLICATION = "euka_email.wsgi.application"
...
# Setup
# psql postgres
# CREATE ROLE ayyan WITH LOGIN PASSWORD 'yani1Mohar';
# CREATE DATABASE eukaemail OWNER ayyan;
# GRANT ALL PRIVILEGES ON DATABASE eukaemail TO ayyan;
...
STATIC_URL = "static/"
STATIC_ROOT = "/var/www/eukaemail/static/"
MEDIA_URL = "/media/"
MEDIA_ROOT = "/var/www/eukaemail/media/"
...
EMAIL_RECEIVER_AS_A_CHECKER = "dev@euka.ai"
